        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <p class="text-s-16 mt-150" style="color:#50151C;">Home > Blogs > <font class="text-s-16 font-wght" style="color:#50151C">{{responseData.title}}</font></p>
                </div>
            </div>
        </div>
        <div class="container">
...
export default {
    ...
    created () {
        this.axios.get(process.env.VUE_APP_API_URL+'/Blogs/' + this.$route.params.id)
