    ...
    <div id="RelatedPosts">               
        <div class="row pt-xxl-1 pt-xl-1 pt-lg-1 pt-2 p-xxl-5 p-xl-5 p-lg-5 p-md-4 p-sm-4 p-4">
            ...
            <div v-if="type == 'Portfolio'" class="row mt-3">
                <div v-for="data in responseData" :key="data.id" :class="{'hide-class':Id == data.id}" class="col-xxl-3 col-xl-3 col-lg-6 col-md-12 col-sm-12 col-12">
                    <a :href="'/Portfolio/Detail/'+data.id+'?type='+data.bu_category.name">
                        <div class="row p-2">
                            <div class="col-xxl-12 col-xl-12 col-lg-6 col-md-6 col-sm-6 col-6 p-2">
                                <img class="img-fix-size" :src="data.illustration.url" :alt="data.illustration.name">
                            </div>
                            <div class="col-xxl-12 col-xl-12 col-lg-6 col-md-6 col-sm-6 col-6 p-2">
...
export default {
    ...
    mounted () {
        if(this.type == 'Portfolio'){
            this.url = 'https://staging-sellsukiadmin.bearyweb.com/Portfolios?bu_category.name='+this.CategoryName+'&_sort=updated_at:DESC&_limit=4'
        }
        else
        {
            this.url = 'https://staging-sellsukiadmin.bearyweb.com/blogs?blog_category.id='+this.CategoryName+'&_sort=updated_at:DESC&_limit=4'
        }
