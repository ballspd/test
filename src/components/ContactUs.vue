            ...
            <div class="row banner-hero">
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="d-none d-md-block d-lg-block d-xl-block d-xxl-block">
                        <p class="text-s-16 mt-150" style="color:#50151C;"><router-link @click="scrollToTop" to="/">Home</router-link> <i class="bi bi-chevron-right"></i> <font class="text-s-16 text-w-700" style="color:#50151C">Contact Us</font></p>
                        <table class="align-middle" style="width: 100%;">
                            <td class="banner-height">
                                ...
                                <p class="text-s-16" style="color:#50151C">สอบถามข้อมูลเพิ่มเติมและปรึกษาเพื่อหาทางออกที่ใช่ให้ธุรกิจคุณ ติดต่อทีมงานของเราได้เลย!</p>
                            </td>
                        </table>
                    </div>
...
export default {
    ...
    methods:{
        submitForm() {
            ...
            .then(
                this.$router.push({name : 'ThankYou',params: { bu: "contact-us" }}),
                this.scrollToTop()
            ).catch((error) => {
                this.$swal.fire({
                    icon: 'error',
