                ...
                <div class="row banner-hero">
                    <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="d-block d-lg-none text-center text-md-start ps-4 pe-4">
                            <p class="text-s-14 mt-4 pb-4 text-start" style="color:#0B0404">Home > Solutions > <font class="text-s-16 text-w-700" style="color:#0B0404">Kaikong</font></p>
                            <h1 class="font-wght text-s-32" style="color:#0B0404">KAIKONG</h1>
                            <h2 class="text-s-24 text-w-700 text-s-30 ps-5 pe-5" style="color:#0B0404">“ช่วยสร้าง CONTENT MARKETING ให้ธุรกิจเป็นที่จดจำ”</h2>
                            <p class="text-s-14 p-4 p-md-0 ps-5 pe-5" style="color:#0B0404">Creative Agency ผู้เชี่ยวชาญในด้านการทำ Content marketing ที่พร้อมจะช่วยสร้างธุรกิจของคุณให้เป็นที่น่าจดจำ เพื่อเพิ่มยอดขาย และเติบโตอย่างก้าวกระโดด</p>
                        </div>
                    </div>
