            ...
            <div class="col-xxl-7 col-xl-7 col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="row d-none d-lg-block" style="margin-top: 80px;">
                    <div class="col-12">
                        ...
                        <router-link @click="scrollToTop" to="/Solutions/Fuse"><img @mouseover="activeBuFuse = true,showHover = false,activeBuLine = false, activeBuAkita = false, activeBuBeary = false, activeBuKaikong = false" class="bu-fuse hvr-grow" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Fuse_b0f13ab75c.webp" alt="Fuse.webp"></router-link>
                        <router-link @click="scrollToTop" to="/Solutions/Line"><img @mouseover="activeBuLine = true,showHover = false,activeBuFuse = false, activeBuAkita = false, activeBuBeary = false, activeBuKaikong = false" class="bu-line hvr-grow" :class="{'auto-pulse':showHover}" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Line_e32da8e76c.webp" alt="Line.webp"></router-link>
                        <router-link @click="scrollToTop" to="/Solutions/Akita"><img @mouseover="activeBuAkita = true,showHover = false,activeBuFuse = false, activeBuLine = false, activeBuBeary = false, activeBuKaikong = false" class="bu-akita hvr-grow" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/AKT_0f1aae1062.webp" alt="Akita.webp"></router-link>
                        <router-link @click="scrollToTop" to="/Solutions/Beary"><img @mouseover="activeBuBeary = true,showHover = false,activeBuFuse = false, activeBuLine = false, activeBuAkita = false, activeBuKaikong = false" class="bu-beary hvr-grow" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Bearyweb_299dd0c679.webp" alt="Beary.webp"></router-link>
                        <router-link @click="scrollToTop" to="/Solutions/Kaikong"><img @mouseover="activeBuKaikong = true,showHover = false,activeBuFuse = false, activeBuLine = false, activeBuAkita = false, activeBuBeary = false" class="bu-kaikong hvr-grow" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Kaikong_dc3a1c2aad.webp" alt="Kaikong.webp"></router-link>
                ...
                <div class="d-block d-lg-none" style="margin-top: -30px;">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-sm-11 col-10">
                            <a><img @click="showHover = false,activeBuFuse = true ,activeBuLine = false, activeBuAkita = false, activeBuBeary = false, activeBuKaikong = false" class="bu-fuse hvr-grow" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Fuse_b0f13ab75c.webp" alt="Fuse.webp"></a>
                            <a><img @click="showHover = false,activeBuLine = true ,activeBuFuse = false, activeBuAkita = false, activeBuBeary = false, activeBuKaikong = false" class="bu-line" :class="{'auto-pulse':showHover}" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Line_e32da8e76c.webp" alt="Line.webp"></a>
                            <a><img @click="showHover = false,activeBuAkita = true ,activeBuFuse = false, activeBuLine = false, activeBuBeary = false, activeBuKaikong = false" class="bu-akita" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/AKT_0f1aae1062.webp" alt="Akita.webp"></a>
                            <a><img @click="showHover = false,activeBuBeary = true ,activeBuFuse = false, activeBuLine = false, activeBuAkita = false, activeBuKaikong = false" class="bu-beary" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Bearyweb_299dd0c679.webp" alt="Beary.webp"></a>
                            <a><img @click="showHover = false,activeBuKaikong = true ,activeBuFuse = false, activeBuLine = false, activeBuAkita = false, activeBuBeary = false" class="bu-kaikong" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Kaikong_dc3a1c2aad.webp" alt="Kaikong.webp"></a>
                            <img class="item-center bu-size" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/SSK_Main_fa38f3ed9d.webp" alt="SSK-Main.webp">
                        </div>
                    </div>
                </div>
            </div>
