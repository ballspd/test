            ...
            <div class="row banner-hero">
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="d-none d-md-block d-lg-block d-xl-block d-xxl-block">
                        <p class="text-s-16 mt-150" style="color:#50151C;"><NuxtLink @click="scrollToTop" to="/">{{ $t("page.Home") }}</NuxtLink> <i class="bi bi-chevron-right"></i> <font class="text-s-16 text-w-700" style="color:#50151C">{{ $t("page.JOINUS.JoinUs") }}</font></p>
                        <table class="align-middle" style="width: 100%;">
                            <td class="banner-height">
                                <h1 class="font-wght" style="font-size:64px;color:#50151C">{{ $t("page.JOINUS.JOINUS") }}</h1>
                                <p class="text-s-16" style="color:#50151C">{{ $t("page.JOINUS.mata") }}</p>
                            </td>
                        </table>
                    </div>
                    <div class="d-block d-md-none d-lg-none d-xl-none d-xxl-none text-center ps-4 pe-4">
                        <p class="text-s-16 text-start" style="color:#50151C;margin-top:95px !important">
                            <NuxtLink @click="scrollToTop" to="/" style="color:#50151C">{{ $t("page.Home") }}</NuxtLink> <i class="bi bi-chevron-right"></i>
                            <font class="text-s-16 text-w-700"><span style="color:#50151C"> {{ $t("page.JOINUS.JoinUs") }}</span></font>
                        </p>
                        <h1 class="font-wght mt-3" style="font-size:36px;color:#50151C">{{ $t("page.JOINUS.JOINUS") }}</h1>
                        <p class="text-s-16" style="color:#50151C">{{ $t("page.JOINUS.mata") }}</p>
                    </div>
                </div>
                <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                    <img class="d-none d-xl-block d-xxl-block img-fluid" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Header_Join_Us_01_1_c83321b0bf.webp" style="margin-top: 80px;">
                    <img class="d-block d-xl-none d-xxl-none img-fluid" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/Header_Join_Us_01_1_c83321b0bf.webp">
                </div>
            </div>
            <div class="crad mt-5">
                    ...
                    <div class="accordion-item" v-for="data in responseData" :key="data.id">
                      ...
                      <div :id="'panelsStayOpen-collapse'+data.id" class="accordion-collapse collapse" :aria-labelledby="'panelsStayOpen-heading'+data.id">
                        <div class="accordion-body">
                          <div class="pt-4">
                            <div v-html="$md.render(data.responsibility)"></div>
                          </div>
                          <div class="pt-4">
                            <div v-html="$md.render(data.qualifications)"></div>
                          </div>
                          <div class="text-center mt-5 pb-4" style="width: 100%">
                              <NuxtLink @click="scrollToTop" href="#" class="btn btn-orange button" :to="{ path: '/join-us-form' , query: { position: data.position } }"><span class="text-white" style="font-size:18px">Apply Now</span></NuxtLink>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default {
    ...
    mounted () {
        axios.get(process.env.API_URL+'job-positions?_locale='+ this.lang)
