            ...
            <div class="row banner-hero">
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="d-none d-md-block d-lg-block d-xl-block d-xxl-block">
                        <p class="text-s-16 mt-150" style="color:#50151C;"><NuxtLink @click="scrollToTop" to="/">Home</NuxtLink> <i class="bi bi-chevron-right"></i> <font class="text-s-16 text-w-700" style="color:#50151C">Join Us</font></p>
                    ...
                    <div class="d-block d-md-none d-lg-none d-xl-none d-xxl-none text-center ps-4 pe-4">
                        <p class="text-s-16 text-start" style="color:#50151C;margin-top:95px !important">
                            ...
                            <font class="text-s-16 text-w-700"><span style="color:#50151C"> Join Us</span></font>
                        </p>
                      ...
                      <div :id="'panelsStayOpen-collapse'+data.id" class="accordion-collapse collapse" :aria-labelledby="'panelsStayOpen-heading'+data.id">
                        <div class="accordion-body">
                          ...
                          <div class="text-center mt-5 pb-4" style="width: 100%">
                              <NuxtLink @click="scrollToTop" href="#" class="btn btn-orange button" :to="{ path: '/JoinUsForm' , query: { position: data.position } }"><span class="text-white" style="font-size:18px">Apply Now</span></NuxtLink>
                          </div>
                        </div>
                      </div>
                    </div>
