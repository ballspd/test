<template>
<div id="SolutionsLine">
    <Preloader/>
    <div class="background-main">
        <div class="pb-lg-0 pb-5" style="background: linear-gradient(180deg, #36A89B 0%, #9FD63E 100%);">
            <div class="container">
                <div class="row banner-hero">
                    ...
                    <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6 col-sm-12 col-12">
                        <img class="d-none d-md-block img-fluid img-banner-top" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/banner_Line_7cac6aa27b.webp" alt="line-by-sellsuki-banner">
                        <img class="d-block d-md-none img-fluid" src="https://s3.ap-southeast-1.amazonaws.com/staging.sellsuki.com-static/banner_Line_7cac6aa27b.webp" alt="line-by-sellsuki-banner">
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    mounted () {
        axios.get(process.env.API_URL+'solution-line-services?_locale='+ this.lang + '&type=LINE_Service')
        .then(response => (this.responseDataH1 = response.data))

        axios.get(process.env.API_URL+'solution-line-services?_locale='+ this.lang + '&type=Add_on_Services')
