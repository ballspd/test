        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <p class="text-s-16 mt-150" style="color:#50151C;"><router-link @click="scrollToTop" to="/">Home</router-link> <i class="bi bi-chevron-right"></i> <router-link @click="scrollToTop" to="/join-us">Join Us</router-link> <i class="bi bi-chevron-right"></i> <font class="text-s-16 font-wght" style="color:#50151C"> {{this.$route.query.position}}</font></p>
                </div>
            </div>
        </div>
        <div class="bg mt-4">
    ...
    methods:{
        ...
        submitForm(){
            ...
            if(this.filename != '' && this.firstName != '' && this.lastName != '' && this.email != '' && this.phoneNumber != '' && this.jobVacancy != '' && this.position != '' && this.expectedSalary != '' && this.tellUs != ''){
                //this.sendEmail();
                console.log('ส่งได้!!');
                window.location.href = window.location.origin + '/thank-you-job';
            }
        },
        sendEmail() {
