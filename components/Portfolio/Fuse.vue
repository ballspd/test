<template>
    <div id="PortfolioFuse">
      <div class="row ps-xxl-4 ps-xl-4">
        <div class="col-12 mb-3 d-block d-xl-none d-xxl-none"><img class="item-center" src="./../../assets/mobile/Fuse-logo.webp" alt="Fuse-logo.webp"></div>
        <div v-for="data in responseData" :key="data.id" class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 p-xxl-0 p-xl-0 p-lg-5 p-md-5 p-sm-4 p-4 mb-4 hvr-hang">
            <NuxtLink @click="scrollToTop" :to="{ path: '/Portfolio/Detail/'+data.id+'/'+data.url+''}">
...
export default {
    ...
    methods : {
        getData(){
            axios.get(process.env.API_URL+'Portfolios?bu_category.name=Fuse&_locale='+ this.lang)
