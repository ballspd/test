            ...
            <div style="background-color: #15304E">
                ...
                <div class="row">
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6 hover-manu">
                        ...
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Solutions/Fuse" class="text-white">ลงโฆษณาออนไลน์</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Solutions/Akita" class="text-white">คลังสินค้าครบวงจร</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Solutions/Line" class="text-white">เปิดบัญชี LINE OA</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Solutions/Beary" class="text-white">ทำเว็บไซต์</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Solutions/Kaikong" class="text-white">ทำคอนเทนต์</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Solutions/Shipmunk" class="text-white">เปรียบเทียบค่าขนส่ง</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Solutions/Oc2Plus" class="text-white">Customer Data Platform</NuxtLink></p>
                    </div>
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6 hover-manu">
                        <p class="text-w-700 font-footer text-white">เกี่ยวกับเรา</p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/AboutUs" class="text-white">ติดต่อเรา</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/JoinUs" class="text-white">ร่วมงานกับเรา</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Portfolio" class="text-white">Portfolio</NuxtLink></p>
                        <p class="text-w-400 font-footer"><NuxtLink @click="scrollToTop" to="/Blog" class="text-white">Blog</NuxtLink></p>
                    </div>
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-xxl-end text-xl-end text-lg-end text-md-end"><p class="text-w-400" style="font-size: 14px;color:#FFFFFF;"><NuxtLink @click="scrollToTop" to="/Policy">Privacy Policy</NuxtLink><i class="fa fa-cloud"></i> <font style="margin-left:6px;margin-right:6px">|</font> <NuxtLink @click="scrollToTop" to="/TermsOfUse">Terms and Conditions</NuxtLink></p></div>
                </div>
                </div>
            </div>  
            </div>
